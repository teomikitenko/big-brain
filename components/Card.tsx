  ...
  return (
    <Card>
      <CardHeader>
        ...
        {data.type === 'files' ? (
          <CardDescription className="hyphens-auto text-pretty break-words text-sm md:text-base" lang="en">
            {data.data.describtion}
          </CardDescription>
        ) : (
          <CardDescription className="hyphens-auto text-pretty break-all" lang="en">
            {data.data.text}
          </CardDescription>
        )}
      </CardHeader>
